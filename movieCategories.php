...
<?php   
    ...
    $categories = $db
                ...
                ->get("categories", null, $cols);
?>
<!-- Three columns of text below the carousel -->
  <select id="movieCategoriesFilter" multiple="multiple" style="width:400px" class="populate placeholder select2-offscreen" tabindex="-1"><option></option>
  <?php
